...
namespace CsWinRTCApp
{
    ...
    sealed partial class App : Application
    {
        ...
        public ChatViewModel ChatVM { get; set; } = new ChatViewModel();
        ...
        public void SignalR()
        {
            conn = new HubConnection("http://localhost:5000/azurehub");
            proxy = conn.CreateHubProxy("ChatHub");
            conn.Start();

            proxy.On<ChatMessage>("send", OnMessage);
